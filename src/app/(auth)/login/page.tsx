...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success("Welcome back to Ex Libris!");
    ...
    <div className="min-h-screen bg-[#fdf6e3] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-gradient-to-br from-[#fdf6e3] via-[#faf0da] to-[#f5e6c8] rounded-lg shadow-2xl border border-amber-200/60 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <label
                  htmlFor="remember"
                  className="text-sm font-serif text-amber-800"
                >
                  Remember me
                </label>
              </div>
              <Link
                ...
                className="text-sm font-serif text-amber-600 hover:text-amber-800 underline decoration-amber-400/50 hover:decoration-amber-600 transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            >
              {isLoading ? (
                <BookLoading loadingText="Signing In" />
              ) : (
                <>
          ...
          {/* Divider */}
          <div className="mt-8">
            <div className="flex items-center justify-center space-x-2 opacity-40 mb-6">
